...
-->
    ...
    <div class="info-card text-center">
        ...
        <p><b>Email:</b> <a href="mailto:nihalxxxxx@gmail.com">nihalxxxxxx@gmail.com</a></p>
        <a href="mailto:nihalxxxx@gmail.com" class="btn btn-primary mt-2">📧 Mail to Nihalvardh games</a>
    -->
        <a href="https://www.youtube.com/@nihalvardh" class="btn btn-primary mt-2">📧 Subsribe Nihalvardh</a>
    </div>

    <!-- Service Links -->
    <div class="info-card text-center">
        <h4>⚙️ Our Services</h4>
        <p><a href="services/Player/getPlayerDetails" class="btn btn-success">Get Player Details</a></p>
    </div>
